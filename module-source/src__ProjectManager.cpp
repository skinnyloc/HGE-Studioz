...
#ifndef HGE_STARTUP_SESSION_TEMPLATE
#define HGE_STARTUP_SESSION_TEMPLATE 1
#endif
...
namespace {
   ...
   void MaybeCreateHgeStartupTemplate(AudacityProject &project)
   {
#if HGE_STARTUP_SESSION_TEMPLATE
...
void InitProjectWindow( ProjectWindow &window )
{
   ...
   auto msg = XO("Welcome to HGE Music Studio %s")
...
AudacityProject *ProjectManager::New()
{
   ...
   MaybeCreateHgeStartupTemplate(project);
