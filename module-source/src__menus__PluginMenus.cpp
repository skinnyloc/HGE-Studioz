...
#ifndef HGE_SHOW_LEGACY_EFFECT_STORE
#define HGE_SHOW_LEGACY_EFFECT_STORE 0
#endif
...
auto GenerateMenu()
{
   ...
   Menu( wxT("Generate"), XXO("&Generate"),
      Section( "Manage",
         Command( wxT("ManageGenerators"), XXO("Manage Creator Tools"),
...
auto EffectMenu()
{
   ...
   static auto menu = std::shared_ptr { Menu(
      ...
      Section(
         "Manage", Command(
                      wxT("ManageEffects"), XXO("Advanced Effect Settings"),
...
#if HGE_SHOW_LEGACY_EFFECT_STORE && (defined(__WXMSW__) || defined(__WXMAC__))
         , Command(
...
auto AnalyzeMenu()
{
   ...
   Menu( wxT("Analyze"), XXO("&Analyze"),
      Section( "Manage",
         Command( wxT("ManageAnalyzers"), XXO("Manage Analysis Tools"),
...
auto ToolsMenu()
{
   ...
   Menu( wxT("Tools"), XXO("T&ools"),
      Section( "Manage",
         Command( wxT("ManageTools"), XXO("Manage Studio Tools"),
